  ...
  return (
    <aside className="sticky top-0 h-screen w-56 flex-shrink-0 border-r border-white/10 bg-slate-900/30 p-6 text-white/80 backdrop-blur-xl">
      ...
      <nav className="space-y-3 text-sm">
        <Link className="block rounded-lg px-2 py-1.5 hover:bg-white/5" href="/home">Home</Link>
        <Link className="block rounded-lg px-2 py-1.5 hover:bg-white/5" href="/">Music</Link>
        <Link className="block rounded-lg px-2 py-1.5 hover:bg-white/5" href="/library">Library</Link>
        <span className="block rounded-lg px-2 py-1.5 text-white/60">What's your mood?</span>
      </nav>
